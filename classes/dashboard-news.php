...
if ( ! class_exists( 'WPF_Dashboard_News' ) ) :
	...
	class WPF_Dashboard_News {
		...
		/**
		 * constructor of class WPF_Dashboard_News
		 *
		...
		public function __construct( $feed_url, $link, $translations ) {
			...
			add_filter( 'pre_set_transient_' . $dashboard_news_transient_name, array(
				$this,
				'pre_set_transient_for_dashboard_news'
			), 10 );
			add_filter( 'transient_' . $dashboard_news_transient_name, array(
				$this,
				'transient_for_dashboard_news'
			), 10 );

			add_action( 'wp_ajax_' . $this->slug . '_ajax_dismiss_dashboard_news', array(
				$this,
				'dismiss_dashboard_news'
			) );
